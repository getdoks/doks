...
// Side-effect import: registers the build-time content snapshot with the
// doks-core runtime cache. Must run before any data-layer call resolves a
// doc. The file is generated by `doks build:content` (predev/prebuild).
